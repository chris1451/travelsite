...
function playPause(){
    if(videoFile.paused){
        ...
        //we change the icon
        videoIcon.classList.remove('bx bx-pause')
        videoIcon.classList.add('bx bx-play')
    }
}
...
//we obtain the current theme that the interferance has by validating the dark-theme class
const getCurrentTheme = () => document.body.classList.contains(darkTheme) ? 'dark' : 'light'
const getCurrentIcon = () => themeButton.classList.contains(darkTheme) ? 'bx-moon' : 'bx-sun'
...
themeButton.addEventListener('click', () => {
    // A dd or remove the dark / icon theme
